...
import { CommandLineIcon, CpuChipIcon, GlobeAltIcon, ShieldCheckIcon, SunIcon } from "@heroicons/react/24/solid";
...
const Web = 
{
    ...
    icon: GlobeAltIcon,
    details:
    "Our Web Applications service delivers robust and scalable digital solutions tailored to your business needs. We use modern frameworks and best practices to create responsive, secure, and high-performance applications. Let us help you transform your ideas into a dynamic online presence.",
  }
    ...
    <div className={`min-h-screen ${isDarkMode ? "bg-gray-900 text-white" : "bg-white text-gray-900"}`}>
      <div className="max-w-5xl mx-auto py-10 pt-28 pb-25 px-4">
        ...
        >
          ...
          <p className={`text-lg md:text-xl mb-4 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>{Web.description}</p>

          {/* Detailed Information */}
          <div className="space-y-4">
            <h2 className={`text-2xl font-semibold ${isDarkMode ? "text-white" : "text-black"}`}>Service Details</h2>
            <p className={`text-lg leading-relaxed ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>{Web.details}</p>
          </div>
        </motion.div>
      </div>
    </div>
