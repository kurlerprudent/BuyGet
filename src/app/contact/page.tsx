      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <motion.div
            initial={{ opacity: 0, x: 50 }}
            animate={{ opacity: 1, x: 0 }}
            className={`bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-white/10 ${isDarkMode ? "" : "border border-gray-300"}`}
          >
            <form className="space-y-6">
              <div>
                <label className={`block ${isDarkMode ? "text-gray-300" : "text-gray-700"} mb-2`}>Full Name</label>
                <input
                  type="text"
                  className={`w-full bg-white/5 rounded-lg px-4 py-3 ${isDarkMode ? "text-white" : "text-black"} border border-white/10 focus:border-purple-500 focus:ring-1 focus:ring-purple-500/30 outline-none transition-all`}
              ...
              <div>
                ...
                <input
                  type="email"
                  className={`w-full bg-white/5 rounded-lg px-4 py-3 ${isDarkMode ? "text-white" : "text-black"} border border-white/10 focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30 outline-none transition-all`}
                  placeholder="john@example.com"
                />
              </div>

              <div>
                <label className={`block ${isDarkMode ? "text-gray-300" : "text-gray-700"} mb-2`}>Message</label>
                <textarea
                  rows={5}
                  className={`w-full bg-white/5 rounded-lg px-4 py-3 ${isDarkMode ? "text-white" : "text-black"} border border-white/10 focus:border-pink-500 focus:ring-1 focus:ring-pink-500/30 outline-none transition-all`}
        ...
        {/* Map Section */}
        <div className={`mt-16 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 overflow-hidden ${isDarkMode ? "" : "border border-gray-300"}`}>
          <div className="h-96 w-full flex items-center justify-center">
            <span className={`text-gray-400 ${isDarkMode ? "text-gray-400" : "text-gray-700"}`}>Map </span>
          </div>
        </div>
      </div>
    </div>
